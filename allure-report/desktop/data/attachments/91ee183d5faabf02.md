...
- Location: tests\cart.spec.ts:50:8
...
Call log:
  - Expect "not toHaveURL" with timeout 5000ms
    8 × unexpected value "https://www.saucedemo.com/checkout-step-one.html"
...
```ts
  ...
  48 |   });
  49 | 
  50 |   test.fail('TC-CART-003: Checkout with empty cart', async ({ page }) => {
  51 | 
